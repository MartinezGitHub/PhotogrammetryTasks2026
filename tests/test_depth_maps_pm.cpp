...
TEST(test_depth_maps_pm, SingleDepthMap)
{
    ...
    std::filesystem::create_directories(std::string("data/debug/test_depth_maps_pm/") + getTestName());
    std::filesystem::create_directories("data/debug/test_depth_maps_pm/iterations_points");
